...
class TestsControllerTest < ActionController::TestCase
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post :create, test: { birth: @test.birth, flag: @test.flag, name: @test.name, salary: @test.salary }
    end
  ...
  test "should update test" do
    patch :update, id: @test, test: { birth: @test.birth, flag: @test.flag, name: @test.name, salary: @test.salary }
    assert_redirected_to test_path(assigns(:test))
  end
